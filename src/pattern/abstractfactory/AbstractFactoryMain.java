 ...
 *          比如说有商务装（成套，一系列具体产品）
 *          时尚装（成套，一系列具体产品）
 *          甚至对于一个家庭来说，可能有商务女装、商务男装、时尚女装、时尚男装，
 *          这些也都是成套的，即一系列具体产品。
...
public class AbstractFactoryMain {
    public static void main(String[] args) {
        ...
        AbstractFactory shapeFactory = FactoryBuilder.getFactory(ShapeFactory.class);
        ...
        AbstractFactory colorFactory = FactoryBuilder.getFactory(ColorFactory.class);
