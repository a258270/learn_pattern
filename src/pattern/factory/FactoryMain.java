...
import pattern.factory.color.Blue;
import pattern.factory.color.ColorFactory;
import pattern.factory.color.Green;
import pattern.factory.color.Red;
import pattern.factory.shape.Circle;
import pattern.factory.shape.Rectangle;
import pattern.factory.shape.ShapeFactory;
import pattern.factory.shape.Square;
...
public class FactoryMain {
    public static void main(String[] args) {
        ...
        Blue blue = (Blue) ColorFactory.getColor(Blue.class);
        blue.fill();

        Green green = (Green) ColorFactory.getColor(Green.class);
        green.fill();
    }
}
